  ...
  handleOk() {
    ...
    if (remotePath) {
      ...
      if (tabType === 1) {
        ...
        templatesManager.custom.edit({ type: 'remote', item: this.remoteObj });
    ...
    if (localPath) {
      ...
      if (tabType === 1) {
        ...
        templatesManager.custom.add({ type: 'local', item: this.localObj });
        // application.addCustomTemplates({
        //   type: 'local',
        //   item: this.localObj,
        // });
      } else {
        templatesManager.custom.edit({ type: 'local', item: this.localObj });
        // application.editCustomTemplates({
        //   type: 'local',
        //   item: this.localObj,
        // });
