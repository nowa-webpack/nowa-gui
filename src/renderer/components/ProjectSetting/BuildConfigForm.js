      ...
      <form className="ui-form" >
        <div className="form-item">
          ...
          <Switch size="default" checked={mangle}
            onChange={checked => this.saveConfig({ mangle: checked })}
          />
        </div>
        ...
        <div className="form-item">
          ...
          <Switch size="default" checked={keepconsole}
            onChange={checked => this.saveConfig({ keepconsole: checked })}
          />
        </div>
        ...
        <div className="form-item">
          ...
          <Switch size="default" checked={exportcss}
            onChange={checked => this.saveConfig({ exportcss: checked })}
          />
        </div>
        ...
        <div className="form-item">
          ...
          <Switch size="default" checked={skipminify}
            onChange={checked => this.saveConfig({ skipminify: checked })}
          />
        </div>
        ...
        <div className="form-item">
          ...
          <input type="text"
            ...
            onBlur={() => this.saveConfig({ minifyExtension })}
